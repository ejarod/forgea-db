...
public class Upcomingtasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcomingtasks);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Upcomingtasks.this, MainActivity.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Upcomingtasks.this, mainMenu.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        myDB = new myDatabasehelper(Upcomingtasks.this);
        ...
        recyclerView = findViewById(R.id.tasklistUpcoming);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        getUpcomingTasks();

        adapter = new recycleAdapter(Upcomingtasks.this, task_id, task_name, task_icon,
        ...
        adapter.setOnItemClickListener(new recycleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, String taskId, String taskName, String taskIcon,
                ...
                Intent intent = new Intent(Upcomingtasks.this, updatetaskpage.class);
